/**
 * 客户询价作废功能数据库迁移脚本
 * 执行命令: node server/scripts/database/migrate-inquiry-void.js
 */
...
async function migrate() {
  ...
  try {
    // 读取迁移SQL文件
    const migrationPath = path.join(__dirname, '../../database/migrations/add_inquiry_void_fields.sql')
