...
async function insertTestData() {
  ...
  try {
    ...
    const fees = [
      ...
      { id: 'fee-001', number: 'FEE20250001', bill_id: 'bl-001', bill_number: 'BP2500001', customer_id: 'cust-001', customer_name: '上海国际贸易有限公司', type: 'receivable', category: 'freight', name: '海运费', amount: 15000, currency: 'CNY', status: 'unpaid' },
      { id: 'fee-002', number: 'FEE20250002', bill_id: 'bl-001', bill_number: 'BP2500001', customer_id: 'cust-001', customer_name: '上海国际贸易有限公司', type: 'receivable', category: 'clearance', name: '报关费', amount: 800, currency: 'CNY', status: 'paid' },
      { id: 'fee-003', number: 'FEE20250003', bill_id: 'bl-003', bill_number: 'BP2500003', customer_id: 'cust-002', customer_name: '深圳电子科技股份有限公司', type: 'receivable', category: 'freight', name: '海运费', amount: 22000, currency: 'CNY', status: 'unpaid' },
      { id: 'fee-004', number: 'FEE20250004', bill_id: 'bl-003', bill_number: 'BP2500003', customer_id: 'cust-002', customer_name: '深圳电子科技股份有限公司', type: 'receivable', category: 'handling', name: '操作费', amount: 500, currency: 'CNY', status: 'paid' },
      { id: 'fee-005', number: 'FEE20250005', bill_id: 'bl-007', bill_number: 'BP2500007', customer_id: 'cust-004', customer_name: '广州汽车零部件有限公司', type: 'receivable', category: 'freight', name: '海运费', amount: 18500, currency: 'CNY', status: 'partial' },
      { id: 'fee-006', number: 'FEE20250006', bill_id: 'bl-009', bill_number: 'BP2500009', customer_id: 'cust-005', customer_name: '青岛海洋食品进出口公司', type: 'receivable', category: 'freight', name: '海运费', amount: 12000, currency: 'CNY', status: 'unpaid' },
      { id: 'fee-007', number: 'FEE20250007', bill_id: 'bl-013', bill_number: 'BP2500013', customer_id: 'cust-007', customer_name: '苏州纺织品出口公司', type: 'receivable', category: 'freight', name: '海运费', amount: 25000, currency: 'CNY', status: 'paid' },
      
      // 应付费用 (payable) - 支付给供应商
      { id: 'fee-008', number: 'FEE20250008', bill_id: 'bl-001', bill_number: 'BP2500001', customer_id: null, customer_name: '马士基航运', type: 'payable', category: 'freight', name: '船公司运费', amount: 12000, currency: 'CNY', status: 'paid' },
      { id: 'fee-009', number: 'FEE20250009', bill_id: 'bl-003', bill_number: 'BP2500003', customer_id: null, customer_name: '中远海运', type: 'payable', category: 'freight', name: '船公司运费', amount: 18000, currency: 'CNY', status: 'unpaid' },
      { id: 'fee-010', number: 'FEE20250010', bill_id: 'bl-007', bill_number: 'BP2500007', customer_id: null, customer_name: '长荣海运', type: 'payable', category: 'freight', name: '船公司运费', amount: 15000, currency: 'CNY', status: 'paid' },
      { id: 'fee-011', number: 'FEE20250011', bill_id: 'bl-009', bill_number: 'BP2500009', customer_id: null, customer_name: 'ONE航运', type: 'payable', category: 'freight', name: '船公司运费', amount: 9500, currency: 'CNY', status: 'unpaid' },
      { id: 'fee-012', number: 'FEE20250012', bill_id: 'bl-013', bill_number: 'BP2500013', customer_id: null, customer_name: '马士基航运', type: 'payable', category: 'freight', name: '船公司运费', amount: 20000, currency: 'CNY', status: 'paid' }
    ]
